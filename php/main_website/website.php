...
<head>
    ...
    <title>Najlepsze przepisy pod słońcem</title>
...
<body>
    ...
    <div class="MyModal modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    ...
    <header>
        <nav class="navbar navbar-expand-sm d-flex justify-content-between">
            <div class="logo_container">
                <div class="logo" style="overflow:auto;">
                    <a class="logo-text" href=""><span class="logo-word">Smakowite</span> <img class="logo-img" src="../../assets//img//logos//white_logo.png" alt="LOGO"><span class="logo-word">Odkrycia</span></a>
                </div>
            </div>
                ...
                <div class="accounts_settings">
                    <div class="links-container">
                        <ul class="nav-links">
                            ...
                            <li class="nav-element open-modal" data-toggle="modal" data-target="#exampleModalCenter"><i class="bmiBtn fa-solid fa-calculator"></i><a>Kalkulator BMI</a></li>
        ...
        <div class="vids_container">
            <!-- <div class="animateText">
                <span class="text-left">SMAKOWITE</span>
                <span class="text-right">ODKRYCIA</span>
            </div> -->
            <a href="#main" style="text-decoration: none;"><button class="btn-grad">Przepisy</button></a>
            <div class="clock"></div>
        </div>
    </header>
    
    <main id="main">
        <div class="recipes_sort_container">
            <div class="sort_search_container">
                <div class="searchBar" id='searchBar'>
                    <i class="search-icon bi bi-search" aria-hidden="true"></i>
                    <input type="search" class="search" id='searchValue' name='search' value="<?php echo isset($_COOKIE['searchValue']) ? urldecode(htmlspecialchars($_COOKIE['searchValue'])) : ''?>" placeholder="Wyszukaj przepis">
            ...
            <div class="recipes_container">
                <div class="recipes_elements_contanier">
                    <?php
    ...
    <footer>
        ...
        <div class="info-container">
            <p>
                <a href="about_us.html">O Nas</a> | <a href="regulamin.html">Regulamin i polityka prywatności</a> | <a href="contact.php">Kontakt</a>
            </p>
        </div>
